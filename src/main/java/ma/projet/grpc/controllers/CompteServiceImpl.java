...
public class CompteServiceImpl extends CompteServiceGrpc.CompteServiceImplBase {
    ...
    public void compteById(GetCompteByIdRequest request, StreamObserver<GetCompteByIdResponse> responseObserver) {
        ...
        if (compte != null) {
            ...
            responseObserver.onCompleted(); // <--- On ferme ICI seulement si succès
        } else {
            // Si pas trouvé, on envoie l'erreur et C'EST TOUT (pas de onCompleted après)
            responseObserver.onError(io.grpc.Status.NOT_FOUND
                    .withDescription("Compte introuvable").asRuntimeException());
        }
    }
